...
lst = [] #list x,y of user drawing
root = Tk()
root.title('PaintFunc GRAPHICS ULTRA HIGH PTS >9K mmr 1,2 pos only dead inside 1000-7') #title
...
def create_table():
    tl1 = Toplevel(root)
    tl1.title("TABLE")
    lstbox = Listbox(tl1,width=200,height=200)
...
btn1 = Button(root,width=15, height=5,text='create', command=lambda:create_table())
